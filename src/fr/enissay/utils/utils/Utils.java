package fr.enissay.utils.utils;
...
public class Utils {
	...
	/**
	 * Permet de colorier chaque lettre une Ã  une dans un mot pour faire une
	...
	/**
	 * RÃ©cupÃ¨re le String aprÃ¨s un caratÃ¨re dans un String
	 *
	 * @param s     String
	 * @param after CaratÃ¨re contenu dans s
	 */
	...
	/**
	 * RÃ©cupÃ¨re un String ignore case dans une List<String>
	 *
	 * @param s String
	 * @param l List<String>
	 * @return List<String>
	...
	/**
	 * Permet de rÃ©cupÃ©rer la lettre correspondant au nombre
	 *
	 * @param i 0 < i < 27
	 */
	...
	/**
	 * RÃ©cupÃ¨re le nombre de miliseconde avant la prochaine minute
	 *
	...
	/**
	 * Permet de rÃ©cupÃ©rer la lettre opposÃ© correspondant au nombre
	 *
	 * @param i 0 < i < 27
	 */
	...
	/**
	 * Permet d'arrondir un double avec x nombre aprÃ¨s la virgule
	 */
	 ...
	 * @return Un s si le nombre est supÃ©rieur Ã  1, sinon un string vide.
	 */
