package fr.enissay.utils.gui.old;
...
import fr.enissay.utils.utils.SpigotUtils;

@Deprecated
public class LentiaMCGUI {
	...
	public LentiaMCGUI(String name, String id, long size, Object data) {
		if (size % columns != 0) {
			size = size + columns - size % columns;
		}
		this.inventory = Bukkit.createInventory(null, (int) size, SpigotUtils.color(name));
